    ...
    return (
        <>
            {!publicKey ? (
                ...
                <div
                    id="my-boxes"
                    className="  flex flex-col justify-center items-center p-10 md:px-64"
                >
                    ...
                    <div className="flex flex-col w-full max-h-screen overflow-y-auto py-12 overflow-visible">
                        {myBoxes && myBoxes.length > 0 ? (
                            myBoxes?.map((box, index) => {
                                return (
                                    <div
                                        key={index}
                                        className=" z-[55] mb-3  flex w-full max-w-screen transform cursor-pointer flex-col justify-between items-center rounded-md bg-background-light bg-opacity-75 p-6 text-accent transition duration-500 ease-in-out hover:-translate-y-1 hover:shadow-lg hover:shadow-accent-dark md:flex-row md:p-4"
                                    >
